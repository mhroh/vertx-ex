package com.devroh.vertx.runner;
...
public class Runner {
    ...
    public static final String EXAMPLES_DIR = "vertx-ex";
    public static final String EXAMPLES_JAVA_DIR = EXAMPLES_DIR + "/src/main/java/";
    ...
    public static void runExample(Class clazz) {
        runExample(EXAMPLES_JAVA_DIR, clazz, new VertxOptions().setClustered(false), null);
    }
